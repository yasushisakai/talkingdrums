...
const int THRESHOLD_PEAK = 38;

//buffer size of signal processing window
//BUFFER_SIZE = 25 -> 5ms 45 ->10ms
const int BUFFER_SIZE = 21;

const float f_s   = 0.023; //0 -0.5
const float bw_s  = 0.025;
const float EMA_a_low_s   = 0.18;     //initialization of EMA alpha (cutoff-frequency)
const float EMA_a_high_s  = 0.87;
