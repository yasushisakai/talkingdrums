...
const int THRESHOLD_PEAK = 40;

//buffer size of signal processing window
//BUFFER_SIZE = 25 -> 5ms 45 ->10ms
const int BUFFER_SIZE = 15;

const float f_s   = 0.028; //0 -0.5
const float bw_s  = 0.032;
const float EMA_a_low_s   = 0.15;     //initialization of EMA alpha (cutoff-frequency)
const float EMA_a_high_s  = 0.86;
