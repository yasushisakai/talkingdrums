...
TCL_EXTRA_CFLAGS='-arch i386 -pipe   -mmacosx-version-min=10.4 '
...
TCL_LD_FLAGS='-arch i386 -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-F/Users/pd/auto-build/tcltk_core-8-5-branch/build/tcl/Deployment -framework Tcl'
...
# compiled.
TCL_SRC_DIR='/Users/pd/auto-build/tcltk_core-8-5-branch/tcl8.5.11'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/pd/auto-build/tcltk_core-8-5-branch/build/tcl/Deployment -ltclstub8.5'
...
TCL_BUILD_STUB_LIB_PATH='/Users/pd/auto-build/tcltk_core-8-5-branch/build/tcl/Deployment/libtclstub8.5.a'
